...
public class MainActivity extends AppCompatActivity implements ILockableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entryRVAdapter = new EntryRVAdapter(entryModelFilteredArrayList, de.androidcrypto.cryptopad.MainActivity.this);
        entriesRV = findViewById(R.id.idRVEntries);

        // setting layout manager for our recycler view.
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(de.androidcrypto.cryptopad.MainActivity.this, RecyclerView.VERTICAL, false);
