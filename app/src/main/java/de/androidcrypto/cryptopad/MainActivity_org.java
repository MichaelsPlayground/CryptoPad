...
public class MainActivity_org extends AppCompatActivity implements ILockableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler = new DBHandler(MainActivity_org.this);
        ...
        entryRVAdapter = new EntryRVAdapter(entryModelFilteredArrayList, MainActivity_org.this);
        entriesRV = findViewById(R.id.idRVEntries);

        // setting layout manager for our recycler view.
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MainActivity_org.this, RecyclerView.VERTICAL, false);
        ...
        btnAddEntry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivity_org.this, AddEntryActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mImportClipboard.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivity_org.this, DatabaseImportClipboard.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mImportFile.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivity_org.this, DatabaseImportFile.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mExportMasterkey.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivity_org.this, MasterkeyExportClipboard.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mAbout.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent i = new Intent(MainActivity_org.this, AboutActivity.class);
                startActivity(i);
                return false;
            }
        });
        ...
        mDeleteAllEntries.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(MainActivity_org.this);
                ...
                RelativeLayout container = new RelativeLayout(MainActivity_org.this);
                ...
                alertDialog.setPositiveButton("löschen", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent i = new Intent(MainActivity_org.this, MainActivity_org.class);
                        startActivity(i);
                    }
                });
    ...
    private void errorAndQuitAlert(String message) {
        AlertDialog alertDialog = new AlertDialog.Builder(MainActivity_org.this).create();
    ...
    private void displayLicensesAlertDialog() {
        ...
        android.app.AlertDialog mAlertDialog = new android.app.AlertDialog.Builder(MainActivity_org.this).create();
